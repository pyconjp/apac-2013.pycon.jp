...
PyCon APAC パトロンスポンサー — 10,000円(個人またはスタートアップ企業用)
-------------------------------------------------------------------------
- Patronスポンサーバナーリンクをサイトに掲載
- スポンサー招待枠 1

パトロンスポンサーは `PyCon APAC 2013 in Japan(Patron) <http://connpass.com/event/2704/>`_ からチケットを購入してください。
