...
スポンサーシップの概要(締め切り: 8月上旬)
=========================================

Platinum スポンサー — 500,000円(終了しました)
----------------------------------------------
...
PyCon APAC Patron スポンサー — 10,000円(個人またはスタートアップ企業用)
-------------------------------------------------------------------------
- Patron スポンサーバナーリンクをサイトに掲載
- スポンサー招待枠 1

Patron スポンサーは `PyCon APAC 2013 in Japan(Patron) <http://connpass.com/event/2704/>`_ からチケットを購入してください。
