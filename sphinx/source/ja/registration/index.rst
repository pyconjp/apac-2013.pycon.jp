...
PyCon APAC チュートリアルの参加費用は「19,800円」です。
チュートリアルのチケットには以下のものが含まれます。

- 9月13日に開催されるチュートリアルの参加費用
- PyCon APAC の参加費(全公演の参加、ランチ、コーヒーブレイク、Tシャツ等のグッズ)

チュートリアルの詳細は :doc:`../program/tutorials` にあります。

なお、遠方の参加者の旅費を支援する制度があります。
詳細は :doc:`support` を参照して申し込みを行なってください(締め切り8月11日)。
